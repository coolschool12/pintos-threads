...
struct thread
  {
    ...
    struct list thread_files;           /* list of all files created by this thread */
    int number_of_files;                /* current number of opened files */
...
struct file_descriptor {
  ...
  struct file * file_itself;            /* the file owned by this discriptor */
};
